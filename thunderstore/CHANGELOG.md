...
- **The food buttons were feeding you raw ingredients.** Best Health, Best Stamina, Best Eitr and Balanced all picked uncooked dough and unbaked pies, and said so in the tooltip. Those prefabs were made by copying the cooked dish and changing only its item type, so they kept the whole food block - and several carry higher numbers than the dish they become, which is how they won every ranking. They really were being eaten, too: the game's check for what a player may eat sits above the eating call the buttons make. The buttons now offer only what the game itself counts as food, which also stops them handing you raw meat and eggs.
