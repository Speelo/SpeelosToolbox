...
namespace SkToolbox
{
    ...
    {
        public static System.Version SkConsoleVersion = new System.Version(1, 1, 1);
        ...
        void DrawInput()
        {
            ...
            {
                SkCommandProcessor.ProcessCommands(outputString, SkCommandProcessor.LogTo.Console);
